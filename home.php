...
?>
  ...
  <div class="data"><a href='#'><center><img src="admin/<?php echo $tampil['name'];?>" width="200" height="200" /></center></a><br />
	  ...
	  <b><a href="?page=detail&amp; Kode=<?php echo $Kode;?>" ><font color="#FF6600">Detail Barang</font></a> &nbsp;</b>
      </div>
...
$query = "SELECT * FROM barang order by kd_barang desc limit $hal, $row";
...
<div align="left"><b>Halaman ke :</b> 
	...
	for ($h = 1; $h <= $max; $h++) {
		$list[$h] = $row * $h - $row;
		echo " <a href='?page=home&hal=$list[$h]'>$h</a> ";
	}
	?>
</div></font>